...
<h2>Bonjour <?php echo $_SESSION['username']; ?>, bienvenu(e) sur votre profil formateur !</h2>
</div>
<?php
...
<div class="text-center">
    <h3>
    <a href="<?php echo $this->config->base_url(); ?>index.php/profil/changer_profil_formateur">Cliquez ici pour modifier votre profil</a>
    </h3>
</div>
<br><br>
<div class="text-center">
    <h3>
    <a href="<?php echo $this->config->base_url(); ?>index.php/profil/changer_mdp_formateur">Cliquez ici pour modifier votre mot de passe</a>
    </h3>
</div>
<br>
