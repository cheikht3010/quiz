    	...
    	<div class="col-lg-12">
            ...
            <?php echo form_open('matchs/update_match'); ?>
                ...
                <div class="row">
                	...
                	<div class="col-md-9">
                		<input type="text" class="form-control" id="intitule" name="intitule" value="<?php echo $lIntitule;?>">
                	</div>
                </div>
                <br>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="date" class="form-control" id="debut" name="debut" value="<?php echo $leDebut;?>" min="2018-11-27">
                    </div>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="date" class="form-control" id="fin" name="fin" value="<?php echo $laFin;?>">
                    </div>
                </div>
