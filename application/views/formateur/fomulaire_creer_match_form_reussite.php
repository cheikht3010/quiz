...
<h2>Le match a été créé avec succés !</h2>
</div>
<br><br>
<div class="container">
	<div class="row">
    	<div class="col-lg-12">
			<form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input readonly="readonly" type="date" class="form-control" id="debut" name="debut" value="<?php echo $leDebut;?>" min="2018-11-27">
                    </div>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input readonly="readonly" type="date" class="form-control" id="fin" name="fin" value="<?php echo $laFin;?>" min="2018-11-27">
                    </div>
                </div>
        ...
        <div class="col-lg-12">
            <form>
                ...
                <div class="col-lg-12 text-center">
                  <div id="success"></div>
                  <input type="button" class="btn btn-primary btn-xl text-uppercase" value="Retour" onclick="window.location.replace('<?php echo $this->config->base_url(); ?>index.php/matchs/code_match_pour_creer_formateur')">
                </div>
            </form>
        </div>
    </div>
